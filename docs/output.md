...
| `qc/fastq_screen/` | HTML files generated by [FastQ Screen](https://www.bioinformatics.babraham.ac.uk/projects/fastq_screen/) for read 1 and read2. Text output is in `txt/` directory.                                        |
| `qc/cutadapt/`     | Log files generated by [cutadapt](http://cutadapt.readthedocs.io/en/stable/installation.html) containing trimming information.                                                                            |
| `qc/multiqc/`      | HTML files generated by [MultiQC](http://multiqc.info/) to collate QC from FastQC, FastQ Screen, cutadapt, samtools flagstat, samtools idxstats, picard CollectMultipleMetrics and picard MarkDuplicates. |                                                   |
...
| Directory                                                    | Description                                                                                                                                                                                       |
|--------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `align/mergeReplicate/`                                      | Replicate-level, merged, coordinate sorted alignment files after the re-marking and removal of duplicates.                                                                                        |
| `align/mergeReplicate/flagstat/`                             | Flagstat files associated with the BAM files before and after duplicate removal.                                                                                                                  |
